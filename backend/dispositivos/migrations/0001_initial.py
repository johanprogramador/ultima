# Generated by Django 5.1.5 on 2025-05-13 20:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placa_cu', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_documento', models.CharField(choices=[('CC', 'Cédula de Ciudadanía'), ('CE', 'Cédula de Extranjería'), ('TI', 'Tarjeta de Identidad'), ('PASAPORTE', 'Pasaporte')], default='CC', max_length=10)),
                ('documento', models.CharField(help_text='Número de documento de identidad', max_length=20, validators=[django.core.validators.MinLengthValidator(5)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('admin', 'Administrador'), ('coordinador', 'Coordinador'), ('celador', 'Celador')], default='admin', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('VIGENTE', 'Vigente'), ('DEVUELTO', 'Devuelto'), ('VENCIDO', 'Vencido')], default='VIGENTE', max_length=10)),
                ('ubicacion_asignada', models.CharField(choices=[('CASA', 'Casa'), ('CLIENTE', 'Cliente'), ('SEDE', 'Sede'), ('OTRO', 'Otro')], default='CASA', help_text='Ubicación donde se usará el dispositivo', max_length=20)),
                ('observaciones', models.TextField(blank=True, null=True)),
                ...
                ('dispositivo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asignaciones_externas', to='dispositivos.dispositivo')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asignaciones', to='dispositivos.usuarioexterno')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='RegistroMovimientoDispositivo',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('observaciones', models.TextField(blank=True, null=True)),
                ('asignacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movimientos', to='dispositivos.asignaciondispositivo')),
                ('registrado_por', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registros_movimientos', to=settings.AUTH_USER_MODEL)),
            ],
            options={
